...
#Region "页面切换"
    ...
    ''' 勾选事件改变页面。
    ''' </summary>
    Private Sub PageCheck(sender As MyListItem, e As RouteEventArgs) Handles ItemAbout.Check, ItemHelp.Check, ItemTest.Check, ItemFeedback.Check, ItemVote.Check, ItemMZMC.Check
    ...
    Public Function PageGet(Optional ID As FormMain.PageSubType = -1)
        ...
        Select Case ID
            ...
            Case FormMain.PageSubType.OtherVote
                ...
                Return FrmOtherVote
            Case FormMain.PageSubType.MZMCSettings
                If FrmMZMCSettings Is Nothing Then FrmMZMCSettings = New PageMZMCSettings
                Return FrmMZMCSettings
            Case Else
