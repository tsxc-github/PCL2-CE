Public Class PageOtherFeedback
    ...
    Public Sub FeedbackListGet(Task As LoaderTask(Of Integer, List(Of Feedback)))
        Dim list As JArray
        list = NetGetCodeByRequestRetry("https://api.github.com/repos/tsxc-github/PCL2-CE/issues?state=all&sort=created&per_page=200", BackupUrl:="https://api.kkgithub.com/repos/tsxc-github/PCL2-CE/issues?state=all&sort=created&per_page=200", IsJson:=True, UseBrowserUserAgent:=True) ' 获取近期 200 条数据就够了
