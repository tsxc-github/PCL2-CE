        ...
        RunInNewThread(
            Sub()
                ...
                Else
                    Changelog = "欢迎使用呀~"
                End If
                If MyMsgBoxMarkdown(Changelog, "PCL MZMC Edition 已更新至 " & VersionBranchName & " " & VersionBaseName, "确定", "完整更新日志") = 2 Then
                    OpenWebsite("https://github.com/tsxc-github/PCL2-CE/releases")
                End If
