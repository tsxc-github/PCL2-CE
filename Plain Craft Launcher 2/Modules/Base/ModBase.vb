...
#Region "声明"
    ...
    '下列版本信息由能工智人自动修改
    Public Const VersionBaseName As String = "v0.0.2" '不含分支前缀的显示用版本名
    Public Const VersionStandardCode As String = "0.0.2." & VersionBranchCode '标准格式的四段式版本号
    ...
    Public Const VersionCode As Integer = 4 '内部版本号
    '自动生成的版本信息
#If DEBUG Then
